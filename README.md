...
OriBot is a chat bot built on the [Hubot][hubot] framework. It was
...
You can start OriBot locally by running:
...
Then you can interact with OriBot by typing `OriBot help`.

    OriBot> OriBot help
    OriBot animate me <query> - The same thing as `image me`, except adds [snip]
    OriBot help - Displays all of the help commands that OriBot knows about.
    ...
